...
public class QuestMgr : MonoBehaviour
{
    ...
    { 
        ...
        dict_questList.Add(30, new QuestData("포탈을 통해 모의 던전을 클리어 하고 돌아오자", new int[] { 1000 }));
    ...
    public void ControlQuestObejct()
    {
        ...
        switch (questId)
        {
            ...
            case 20:
                ...
                bool eqck = GameUiMgr.single.AllEquipChek();
                Debug.Log(eqck.ToString() );
                if (questActionIndex == 0)
                {
                    Debug.Log("Qid 20");
                }
